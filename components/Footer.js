...
const ThemeSwitcher = () => {
  return (
    <div className="flex mt-6 bg-opacity-5 dark:bg-opacity-10 bg-black backdrop-blur-lg  drop-shadow-lg justify-center  rounded-3xl p-1">
      <button
        type="button"
...
export default function Footer({ copyrightText }) {
  return (
    <footer className="py-16 mx-4 flex flex-col items-center">
      <p className="dark:text-white text-center uppercase mb-3 font-bold opacity-60 text-[16px]">
        {copyrightText}
      </p>
      <ThemeSwitcher />
    </footer>
